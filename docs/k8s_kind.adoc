...
speaker-xxxxx                 1/1     Running   0          26s
----
...
NAME                            READY   STATUS              RESTARTS   AGE
go-hello-app-6cf496f84c-aaaaa   0/1     ContainerCreating   0          0s
go-hello-app-6cf496f84c-bbbbb   0/1     ContainerCreating   0          0s
$ kubectl get services
NAME               TYPE           CLUSTER-IP      EXTERNAL-IP      PORT(S)          AGE
...
++ kubectl get pod go-hello-app-6cf496f84c-aaaaa -o 'jsonpath={.status.podIP}'
+ POD_IP=10.244.0.12
+ docker container exec kind-1-control-plane curl -s http://10.244.0.12:8080/hello
{"message":"Hello, world!"}
++ kubectl get pod go-hello-app-6cf496f84c-bbbbb -o 'jsonpath={.status.podIP}'
+ POD_IP=10.244.0.13
...
$ kubectl get pods -l app=go-hello-app
NAME                            READY   STATUS    RESTARTS   AGE
go-hello-app-6cf496f84c-aaaaa   1/1     Running   0          32m
go-hello-app-6cf496f84c-bbbbb   1/1     Running   0          32m
----
+
[source,console]
----
$ kubectl port-forward go-hello-app-6cf496f84c-aaaaa 3000:8080
Forwarding from 127.0.0.1:3000 -> 8080
Forwarding from [::1]:3000 -> 8080
...
[source,console]
----
$ kubectl port-forward go-hello-app-6cf496f84c-bbbbb 3000:8080
Forwarding from 127.0.0.1:3000 -> 8080
Forwarding from [::1]:3000 -> 8080
...
----
